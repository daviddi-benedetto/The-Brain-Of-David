...
.internal-link, .external-link {
  color: #a1ccfc !important;
  font-style: italic !important;
  text-decoration: none !important;
}

.internal-link:active, .internal-link:hover, .external-link:active, .external-link:hover {
  opacity: 0.7 !important; /* Slightly fade the link on hover for visual feedback */
}

/* Makes Menu Letters Capital */
.tree-item{
...
body {
  ...
  --blue: #b9d6ff; /* More color for --h1-color */
  --pink: #ffbbd5; /* More color for --h2-color */
  --green: #bdf9ff; /* More color for --h3-color */
  --yellow: #ffe8c4; /* More color for --h4-color */
  --orange: #ffd4ba; /* More color for --h5-color */
  --purple: #dcc8ff; /* More color for --h6-color */
  
  --h1-color: var(--blue); /* Uses the blue with more color */
  --h2-color: var(--purple); /* Uses the pink with more color */
  --h3-color: var(--green); /* Uses the green with more color */
  --h4-color: var(--yellow); /* Uses the yellow with more color */
  --h5-color: var(--orange); /* Uses the orange with more color */
  --h6-color: var(--pink); /* Uses the purple with more color */

  --tag-background-color-l: #dee8e4;
  --tag-font-color-l: #345e4e;
  --tag-background-color-d: #345e4e;
  --tag-font-color-d: #e5e5e5;
...
body.theme-dark.is-mobile {
  ...
  --color-red: #ec7478; /* A softer red */
  --color-green: #41b664; /* A more subdued green */
  --color-orange: #d28737; /* A warmer orange */
  --color-yellow: #ccca62; /* A darker, more muted yellow */
  --color-cyan: #49cac8; /* A less bright cyan */
  --color-blue: #3288e8; /* A brighter but less saturated blue */
  --color-purple: #c6b1f6; /* A lighter purple */
  --color-pink: #ea7fb9; /* A less intense pink */
  --color-base-00: #1a1a1a; /* A slightly lighter main editor window color */
  --color-base-10: #2d3037; /* A lighter code block color */
  --color-base-20: #1b1e22; /* A lighter top unselected unfocused nav color */
  --color-base-25: #323640; /* Adjusted for a slight increase in lightness */
  --color-base-30: #3b3e43; /* A slightly lighter shade */
  --color-base-35: #454545; /* A lighter grey */
  --color-base-40: #5d5d5d; /* A lighter grey */
  --color-base-50: #707070; /* A lighter unfocused text color */
  --color-base-60: #a8a8a8; /* A lighter grey */
  --color-base-70: #cccccc; /* A lighter grey */
  --color-base-100: #efefef; /* A much lighter grey */  
  --color-accent-hsl: var(--accent-h), var(--accent-s), var(--accent-l);
  --color-accent: hsl(var(--accent-h), var(--accent-s), var(--accent-l));
  --color-accent-1: hsl(
    var(--accent-h),
